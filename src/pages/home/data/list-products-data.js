...
import bodien from "../../../assets/img-electronic-components/bo-dien.png";
import dongcogiamtoc from "../../../assets/img-electronic-components/dong-co-giam-toc.png";
import keonen from "../../../assets/img-electronic-components/keo-nen.png";
import sungbankeo from "../../../assets/img-electronic-components/sungbankeo.png";
import dayrut from "../../../assets/img-electronic-components/dayrut.png";
import bangkeoden from "../../../assets/img-electronic-components/bang-keo-den.png";
import kemBam from "../../../assets/img-electronic-components/kem-bam.png";
...
import xe1 from "../../../assets/xedieukhientuxa/xe1.png";
import xe2 from "../../../assets/xedieukhientuxa/xe2.png";
import xe3 from "../../../assets/xedieukhientuxa/xe3.png";
import xe4 from "../../../assets/xedieukhientuxa/xe4.png";
import xe5 from "../../../assets/xedieukhientuxa/xe5.png";
import xe6 from "../../../assets/xedieukhientuxa/xe6.png";
...
const dataCategories = [
    ...
    icon: '🚙',
    products: [
      { name: 'Xe địa hình điều khiển từ xa lớn cho trẻ em,Đồ chơi leo núi điện 2WD', image: xe1, link: 'https://s.shopee.vn/4qE7Ftrz9u' },
      { name: 'Xe điều khiển từ xa drift tốc độ cao tỉ lệ 1:24-GTR,2 cầu,pin sạc', image: xe2, link: 'https://s.shopee.vn/9fJN1PwwoS' },
      { name: 'Máy xúc điều khiển từ xa đồ chơi cho bé có gầu sắt, bánh xích', image: xe3 , link: 'https://s.shopee.vn/1VxfJa8F5o' },
      { name: 'Xe ben - Điều khiển từ xa (RC), nâng hạ thùng ben, lốp cao su', image: xe4, link: 'https://s.shopee.vn/30mT6wHUSl' },
      { name: 'Xe tải chở hàng - Điều khiển từ xa (RC)', image: xe5, link: 'https://s.shopee.vn/9zwDSFtUEj'},
      { name: 'Xe đua F1 điều khiển từ xa với tốc độ cao', image: xe6, link: 'https://s.shopee.vn/7VEsU32FKS'},
]
  },
  {
  title: 'Sản phẩm khác',
...
},
{
...
},
  {
    ...
    icon: '⚙️',
    products: [
      { name: 'Bộ lắp ghép mô hình kĩ thuật', image: imgBolapghep, link: 'https://s.shopee.vn/4fugbEP3c6' },
      { name: 'Bộ Thực Hành Công Nghệ Lớp 5 (Gồm Các Thiết Bị Điện, Điện tử)', image: bodien, link: 'https://s.shopee.vn/7prikIpPYY' },
      { name: 'CELL Pin 18650 dung lượng cao 4200mAh 3.7V', image: pinlion, link: 'https://s.shopee.vn/8AUYqGJrvN' },
      { name: 'Công tắc bập bênh KDC1-101 6A-250V', image: congtacbapbenh, link: 'https://s.shopee.vn/gOXzVFg20' },
      { name: 'Động Cơ Mini V2 3VDC-9VDC', image: motorMini, link: 'https://s.shopee.vn/W57ubRzcX'},
            { name: ' Động cơ vàng giảm tốc 1 trục', image: dongcogiamtoc, link: 'https://s.shopee.vn/9Uzwka6OLz'},
                  { name: 'Motor 550 RS550', image: imgmotor550, link: 'https://s.shopee.vn/7Ac1cR7upZ'},
    ...
    icon: '🛠️',
    products: [
      { name: 'Keo 502 con voi loại tốt dán sắt dính chắc 30-50-100ml', image: keo502Max, link: 'https://s.shopee.vn/9pcn5ByoaK' },
      { name: 'Tua vít hỗ trợ lắp ráp', image: tuavit, link: 'https://s.shopee.vn/AKZ3X20hjl' },
      { name: '(Combo 5 Và 10 Cây ) Keo Cây Keo Nến Silicon lớn hoặc nhỏ', image: keonen , link: 'https://s.shopee.vn/18rSNjyLt' },
      { name: 'Súng Bắn Keo Nến Silicon Trắng To Và Nhỏ Loại Xịn', image: sungbankeo, link: 'https://s.shopee.vn/AUsTy4QxvM' },
      { name: 'Bó 100 Dây Thít, Dây Rút, Lạt Nhựa JingDa- Màu Trắng Đen', image: dayrut, link: 'https://s.shopee.vn/9UzwmWIgnz'},
      { name: 'Băng dính cách điện Nano', image: bangkeoden, link: 'https://s.shopee.vn/7KvSCuMWmQ'},
