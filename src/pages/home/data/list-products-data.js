...
},
{
...
},
  {
    ...
    products: [
      ...
      { name: 'Bộ Thực Hành Công Nghệ Lớp 5 (Gồm Các Thiết Bị Điện, Điện tử) siêu đầy đủ phục vụ học tập lắp ráp', image: bodien, link: 'https://s.shopee.vn/7prikIpPYY' },
      { name: 'CELL Pin 18650 dung lượng cao 4200mAh 3.7V', image: pinlion, link: 'https://s.shopee.vn/8AUYqGJrvN' },
      { name: 'Công tắc bập bênh KDC1-101 6A-250V Kích Thước 21*15mm Công Tắc ON/OFF Đỏ Đen', image: congtacbapbenh, link: 'https://s.shopee.vn/gOXzVFg20' },
    ...
    products: [
      ...
      { name: '(Combo 5 Và 10 Cây ) Keo Cây Keo Nến Silicon lớn hoặc nhỏ ( Lớn 25cm Nhỏ 28,5cm) Súng bắn keo nến', image: keonen , link: 'https://s.shopee.vn/18rSNjyLt' },
